...
// The pool stays open at all times, gameweek included: every unclaimed
// player is an instant free agent pickup, no window to wait for. Dropped
// players are still locked until the next gameweek so nobody re-claims what
// they just dropped in the same breath.
